...
Component.prototype.createOperations = function()
{
    try {
		...
		if (installer.value("os") == "win") { 
			component.addOperation("CreateShortcut", "@TargetDir@/Navs.exe", "@DesktopDir@/Navs.lnk", "-param");
			component.addOperation("CreateShortcut", "@TargetDir@/Navs.exe", "@StartMenuDir@/Navs.lnk", "-param");
			component.addOperation("CreateShortcut", "@TargetDir@/Navs_Reinstall_Helper", "@StartMenuDir@/Navs_Reinstall_Helper.lnk", "-param");
			//component.addOperation("CreateShortcut", "@TargetDir@/Navs_Reinstall_Helper.exe");
			//component.addOperation("Execute", "@TargetDir@/vc_redist.x64");
        }
    } catch (e) {
        console.log(e);
    }
